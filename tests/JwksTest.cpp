...
TEST(JwksTest, MultiKeysParse) {
	...
	"keys": [
  	...
  	ASSERT_THROW(jwt::parse_jwks("__not_json__"), jwt::error::invalid_json_exception);
  	ASSERT_THROW(jwt::parse_jwks(R"##(["not","an","object"])##"), std::bad_cast);
  	ASSERT_THROW(jwt::parse_jwks(R"##({"missing": "keys"})##"), jwt::error::invalid_json_exception);
